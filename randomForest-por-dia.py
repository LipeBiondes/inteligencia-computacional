...
modelo = RandomForestRegressor(n_estimators=100, max_depth=8, random_state=42)  # Defina o número de estimadores (n_estimators) e profundidade máxima da árvore (max_depth)
